...
export default function ProdutoItem(props: ProdutoItemProps) {
    ...
    return (
        <Link 
            ...
            className="flex flex-col bg-violete-dark border-white/10 
        ...
        >
            ...
            <div className="flex-1 flex flex-col p-5 gap-3 border-t border-white/10">
                ...
                <span className="text-sm border-b border-dashed self">
                ...
                <button
                    className="flex justify-center items-center h-8 gap-2
